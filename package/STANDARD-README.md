# Theo's Render Pipeline — Standard, 0.1.3 NR candidate
...
1. Install and enable this ZIP in MO2. Disable other upscaler and frame-generation mods.
...
AMD/Intel and ReShade integration are not supported. ENB is optional; setups
without ENB have not been validated.
...
For the RTX 40 MFG unlock or experimental RTX 30 support, install the 0.1.3 Full
...
This NR-enabled Standard candidate has not been tested in-game. Earlier 0.1.3
Full NR and Standard menu checks apply only to their recorded builds.
