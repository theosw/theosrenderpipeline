# RTX 20 volunteer test — Universal 0.2.4

This is a separate experimental test build, not confirmed RTX 20 support.
It includes the 0.2.4 menu and local startup/settings hardening. Its Turing
frame-generation path has offline validation but needs real RTX 20 testing.
...
1. Keep the regular **Standard 0.2.3 or 0.2.4** enabled for its NVIDIA runtimes.
   ...
   **Theo's Render Pipeline - Universal RTX20 Test**. Enable it below Standard
